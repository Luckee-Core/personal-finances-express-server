export const DEFAULT_TRANSACTION_CATEGORY_ASSIGN_SYSTEM_PROMPT = `You assign personal finance categories to bank transactions. Respond with JSON only, no markdown.
