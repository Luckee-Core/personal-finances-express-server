...
import type {
  ...
  UpdateTransactionCategoryAssignAiExchangeInput,
} from './types';

/**
 * Updates a slug-assign AI exchange row.
 */
export const updateTransactionCategoryAssignAiExchange = async (
  supabase: SupabaseClient,
  id: string,
  input: UpdateTransactionCategoryAssignAiExchangeInput,
  ...
  if (error) {
    throw new Error(`Failed to update category assign exchange: ${error.message}`);
  }
