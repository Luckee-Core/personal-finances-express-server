...
import type {
  CreateTransactionCategoryAssignAiRequestInput,
 ...
 */
export const createTransactionCategoryAssignAiRequest = async (
  supabase: SupabaseClient,
  input: CreateTransactionCategoryAssignAiRequestInput,
  ...
  if (error) {
    throw new Error(`Failed to create category assign request: ${error.message}`);
  }
