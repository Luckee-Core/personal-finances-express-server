...
import type {
  CreateTransactionSlugAssignAiResponseInput,
  TransactionSlugAssignAiResponse,
} from './types';

/**
 * Inserts a slug-assign AI response row.
 */
export const createTransactionSlugAssignAiResponse = async (
  supabase: SupabaseClient,
  input: CreateTransactionSlugAssignAiResponseInput,
  ...
  if (error) {
    throw new Error(`Failed to create slug assign response: ${error.message}`);
  }
